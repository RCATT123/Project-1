...
public class FixturesFragment_ViewBinding implements Unbinder {
  ...
  @UiThread
  public FixturesFragment_ViewBinding(final FixturesFragment target, View source) {
    this.target = target;

    View view;
    target.mTitle = Utils.findRequiredViewAsType(source, R.id.fixtures_title_text_view, "field 'mTitle'", TextView.class);
    target.mViewPager = Utils.findRequiredViewAsType(source, R.id.fixtures_view_pager, "field 'mViewPager'", ViewPager.class);
    target.mNoDataTextView = Utils.findRequiredViewAsType(source, R.id.fixtures_no_data_text_view, "field 'mNoDataTextView'", AutofitTextView.class);
    target.mFooter = Utils.findRequiredViewAsType(source, R.id.fixtures_footer, "field 'mFooter'", LinearLayout.class);
    view = Utils.findRequiredView(source, R.id.fixtures_arrow_left, "method 'onPrevImageClick'");
    view2131689789 = view;
    ...
    view = Utils.findRequiredView(source, R.id.fixtures_arrow_right, "method 'onNextImageClick'");
    view2131689790 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
  ...
  @CallSuper
  public void unbind() {
    FixturesFragment target = this.target;
