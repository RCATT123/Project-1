...
public class PrivacyFragment_ViewBinding implements Unbinder {
  ...
  @UiThread
  public PrivacyFragment_ViewBinding(final PrivacyFragment target, View source) {
    this.target = target;

    View view;
    target.mTitle = Utils.findRequiredViewAsType(source, R.id.privacy_title, "field 'mTitle'", TextView.class);
    target.mContent = Utils.findRequiredViewAsType(source, R.id.privacy_content, "field 'mContent'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    PrivacyFragment target = this.target;
